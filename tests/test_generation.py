...
class TestProjectGeneration:
    """Test that projects can be generated successfully."""
    ...
    def test_project_has_valid_python_syntax(self, generate):
    ...
    def test_project_has_valid_yaml_files(self, generate):
    ...
    def test_project_structure_is_correct(self, generate):
...
class TestDependencyManagers:
    """Test different dependency managers."""

    def test_uv_pyproject_generated(self, generate):
    ...
    def test_poetry_pyproject_generated(self, generate):
...
class TestAPIStyles:
    """Test different API framework configurations."""

    def test_drf_api_generated(self, generate):
    ...
    def test_graphql_api_generated(self, generate):
    ...
    def test_both_apis_generated(self, generate):
    ...
    def test_no_api_excludes_frameworks(self, generate):
...
class TestFrontendOptions:
    """Test different frontend configurations."""

    def test_htmx_frontend_templates_generated(self, generate):
    ...
    def test_nextjs_frontend_generated(self, generate):
    ...
    def test_no_frontend_has_minimal_templates(self, generate):
...
class TestAuthBackends:
    """Test authentication backend configurations."""

    def test_allauth_configuration(self, generate):
    ...
    def test_jwt_configuration(self, generate):
    ...
    def test_both_auth_backends(self, generate):
